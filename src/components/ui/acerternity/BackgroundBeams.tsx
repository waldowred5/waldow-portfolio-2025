...
import { cn, convertToHex } from '@/lib/utils.ts';
import { type ITheme, THEME_COLORS, useTheme } from '@/store/useTheme.ts';
...
export const BackgroundBeams = memo(
  ({ className }: { className?: string }) => {
    ...
    const primaryColor = convertToHex(THEME_COLORS[theme].primary);
          ...
          <defs>
            {paths.map((_, index) => (
              ...
              >
                ...
                <stop offset={'100%'} stopColor={tertiaryColor} stopOpacity={'0'}></stop>
              </motion.linearGradient>
            ))}
